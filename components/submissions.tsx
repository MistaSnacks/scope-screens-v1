...
export async function Submissions() {
  ...
  return (
    <section className="flex flex-col items-center gap-9 border-t border-hairline bg-bg-alt px-5 py-24 md:shell-x">
      {/* Eyebrow */}
      ...
      <Reveal className="flex items-center justify-center gap-4">
        ...
        <div className="flex flex-col items-center gap-2">
          ...
          <KineticText as="h2" className="pulp text-center font-display text-[3.25rem] uppercase leading-[0.92] md:text-[3.75rem]" text={heading} />
      ...
      <div className="flex flex-wrap items-center justify-center gap-3">
        {chips.map((c, i) => (
          <span key={`${i}-${c.label}`} className="flex items-center gap-2 rounded-full border border-hairline px-3.5 py-2 font-mono text-[0.75rem] tracking-[0.1em] text-fg/80">
